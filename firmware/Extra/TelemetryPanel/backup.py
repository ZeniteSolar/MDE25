...
sense_input_current = deque(maxlen=MAX_SAMPLES)
...
line_iin, = ax_i.plot([0], [0], label="Iin")
...
def update_plot(frame):
    while not telemetry_queue.empty():
        ...
        sense_input_current.append(data['sense_input_current'])
    ...
    line_iin.set_data(timestamps, sense_input_current)
    ...
    return line_setpoint, line_cp, line_vin, line_vout, line_iin, cp_line, sp_line
